...
if strcmp(option,'confun')
    ...
    for iNode=1:(nNodesDur-1)
        ...
        srfx2 = (1 / (1 + exp(-50 * rfx2)));
        srfy2 = (1 / (1 + exp(-50 * rfy2)));
        slfx2 =  (1 / (1 + exp(-50 * lfx2)));
        ...
        srfx1 = (1 / (1 + exp(-50 * rfx1)));
        srfy1 = (1 / (1 + exp(-50 * rfy1)));
        slfx1 = (1 / (1 + exp(-50 * lfx1)));
...
elseif strcmp(option,'jacobian')
    ...
    for iNode = 1:(nNodesDur-1)
        ...
        output(ic(1), idxFxToeLinX(delayed_index2)) = sigmoid_left*m*Kgrf/c * slfx2*(1+50*lfx2*(1-slfx2));
        output(ic(1), idxFxHeelLinX(delayed_index2)) = sigmoid_left*m*Kgrf / c * slfx2*(1+50*lfx2*(1-slfx2));
        output(ic(1), idxFxToeLinX(delayed_index)) = -sigmoid_left*m*Kgrf/c * slfx1*(1+50*lfx1*(1-slfx1));
        output(ic(1), idxFxHeelLinX(delayed_index)) = -sigmoid_left*m*Kgrf / c * slfx1*(1+50*lfx1*(1-slfx1));
        ...
        output(ic(2), idxFxToeRinX(delayed_index2)) = sigmoid_right*m*Kgrf/c * srfx2*(1+50*rfx2*(1-srfx2));
        output(ic(2), idxFxHeelRinX(delayed_index2)) = sigmoid_right*m*Kgrf / c * srfx2*(1+50*rfx2*(1-srfx2));
        output(ic(2), idxFxToeRinX(delayed_index)) = -sigmoid_right*m*Kgrf/c * srfx1*(1+50*rfx1*(1-srfx1));
        output(ic(2), idxFxHeelRinX(delayed_index)) = -sigmoid_right*m*Kgrf / c * srfx1*(1+50*rfx1*(1-srfx1));
