...
classdef Gait2d_osim_tread < Gait2d_osim
   ...
   %     Kd = 0%;-0.007906228565342;
     ...
     % %  for 2
     % 
        % Kfy = -6.69955993943661e-07;
        % Kfx = 3.44159024751562e-06;
        % Kp = 0.503435152238419;
        % Kd= 0%-0.00640880098689386
     % 
     % %%for 1.6
     % Kfy = -7.04129366507514e-07;
     % Kfx =  2.90354760180188e-06
     % Kp = 0.550479843306388;
     % Kd = 0;%-0.00766813283668818

     %%for 1.4
     % Kfy = -3.99336592444457e-07;
     % Kfx =  1.67330460076226e-06;
     % Kp = 0.342133359986948;
     % Kd = 0%-0.00795189134921472;

    %  %for 1.2
    %  Kfy = -4.051995699115734e-07;
    % Kfx = 1.986559218803390e-06;
    % Kp = 0.283662655343288;
    % Kd=0;

  % for 1
        Kfy = -6.50730832696896e-07;
        Kfx = 3.68273392498989e-06;
        Kp = 0.423209852491857;
        Kd=0;
