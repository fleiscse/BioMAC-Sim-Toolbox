...
% Additional Objective? Dunno which paper that was
%problem.addObjective(@jointAccelerationTerm, 0.001);
%problem.addObjective(@metabolicRateTerm, 0.0001)%,eps_marg,[s_e,l_e]);
%problem.addObjective(@passiveMomentTerm, 1);
